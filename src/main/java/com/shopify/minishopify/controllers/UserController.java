...
import com.shopify.minishopify.payload.request.LoginRequest;
import com.shopify.minishopify.payload.request.SignupRequest;
import com.shopify.minishopify.payload.response.JwtResponse;
import com.shopify.minishopify.payload.response.MessageResponse;
import com.shopify.minishopify.repository.RoleRepository;
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    case "admin":
                        ...
                        break;
                    case "shop":
                        Role shopRole = roleRepository.findByRole(Role.ERole.ROLE_SHOP)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(shopRole);
